...
net_error_t     windows_net_socket_create               (net_family_t, net_protocol_t, net_socket_flags_t, net_socket_t**);
...
net_error_t     windows_net_socket_accept               (net_socket_t*, net_socket_t**);
