...
net_error_t     linux_net_socket_create               (net_family_t, net_protocol_t, net_socket_type_t, net_socket_t**);
...
net_error_t     linux_net_socket_receive              (net_socket_t*, void*, size_t, net_address_t*, size_t*);
net_error_t     linux_net_socket_accept               (net_socket_t*, net_socket_t**);
net_error_t     linux_net_address_parse               (const char*, net_family_t, net_address_t*);
net_error_t     linux_net_htons                       (uint16_t, uint16_t*);
net_error_t     linux_net_ntohs                       (uint16_t, uint16_t*);    
net_error_t     linux_net_address_to_string           (const net_address_t*, char*, size_t, bool);
net_error_t     linux_net_socket_get_address          (net_socket_t*, net_address_t*);
net_error_t     linux_net_socket_get_type             (net_socket_t*, net_socket_type_t*);
net_error_t     linux_net_socket_get_protocol         (net_socket_t*, net_protocol_t*);
