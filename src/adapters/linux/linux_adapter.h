...
net_socket_t*   linux_net_socket_create               (net_family_t, net_protocol_t , int);
...
net_socket_t*   linux_net_socket_accept               (net_socket_t*, net_address_t*);
...
const char*     linux_net_address_to_string           (const net_address_t*, char*, size_t);
...
const char*     linux_net_socket_last_error           (net_socket_t*);
const char*     linux_net_error_string                (net_error_t);
