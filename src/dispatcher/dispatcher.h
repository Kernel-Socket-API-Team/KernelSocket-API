...
typedef struct {
    ...
    net_socket_t*   (*bind_net_socket_create)               (net_family_t, net_protocol_t , int);
    ...
    net_error_t     (*bind_net_socket_listen)               (net_socket_t*, int);
    net_socket_t*   (*bind_net_socket_accept)               (net_socket_t*, net_address_t*);
    net_error_t     (*bind_net_socket_send)                 (net_socket_t*, const void*, size_t, size_t*);
    net_error_t     (*bind_net_socket_send_to)              (net_socket_t*, const void*, size_t, const net_address_t*, size_t*);
    net_error_t     (*bind_net_socket_receive)              (net_socket_t*, void*, size_t, size_t*);
    net_error_t     (*bind_net_socket_receive_from)         (net_socket_t*, void*, size_t, net_address_t*, size_t*);
    net_error_t     (*bind_net_address_parse)               (const char*, uint16_t, net_address_t*);
    const char*     (*bind_net_address_to_string)           (const net_address_t*, char*, size_t);
    net_error_t     (*bind_net_socket_get_local_address)    (net_socket_t*, net_address_t*);
    ...
    const char*     (*bind_net_socket_last_error)           (net_socket_t*);
    const char*     (*bind_net_error_string)                (net_error_t);
