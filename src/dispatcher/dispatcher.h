...
typedef struct {
    ...
    net_error_t     (*bind_net_socket_accept)               (net_socket_t*, net_address_t*, net_socket_t*);
    ...
    net_error_t     (*bind_net_address_to_string)           (const net_address_t*, char*, size_t, const char*);
