...
// Компиляция в Developer PowerShell for VS: cl echo_server_windows.c ws2_32.lib /Fe:build\echo_server_windows.exe
// /Fo:build\echo_server_windows.obj Запуск:     echo_server_windows.exe <port> <tcp|udp> <ipv4|ipv6>
